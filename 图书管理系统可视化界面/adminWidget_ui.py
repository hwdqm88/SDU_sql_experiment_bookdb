...
class Ui_Widget(object):
    ...
    def retranslateUi(self, Widget):
        ...
        self.label.setText(QCoreApplication.translate("Widget", u"\u5f53\u524d\u6a21\u5f0f\uff1a\u7ba1\u7406\u5458\u6a21\u5f0f", None))
        self.lineEdit_name.setText("")
        self.lineEdit_name.setPlaceholderText(QCoreApplication.translate("Widget", u"\u9ed8\u8ba4\uff1aadmin", None))
        self.label_2.setText(QCoreApplication.translate("Widget", u"\u8d26\u53f7\uff1a", None))
        self.lineEdit_password.setText("")
        self.lineEdit_password.setPlaceholderText(QCoreApplication.translate("Widget", u"\u9ed8\u8ba4\uff1aadmin", None))
